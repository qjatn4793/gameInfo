...
<body>
    <div th:fragment="admin-sidenav" id="layoutSidenav_nav">
        <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
            <div class="sb-sidenav-menu">
                <div class="nav">
                    ...
                    <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="/admin/adminUser">사용자 관리</a>
                            <a class="nav-link" href="/admin/adminProduct">상품 관리</a>
                            <a class="nav-link" href="/admin/adminBoard">게시판 관리</a>
                            <a class="nav-link" href="/admin/adminDesign">디자인 관리</a>
                        </nav>
                    </div>
                </div>
            </div>
