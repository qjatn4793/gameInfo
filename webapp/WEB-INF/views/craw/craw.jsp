...
<html lang="en" xmlns:th="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <!-- Navigation-->
        <%--<div th:replace="/nav_craw.jsp :: common-nav"></div>--%>
        ...
        <!-- Header-->
        <%--<div th:replace="/header_craw.jsp :: common-header"></div>--%>
        <header th:fragment="common-header" class="bg-dark py-5 bg-craw">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">Craw</h1>
                    <p class="lead fw-normal text-white-50 mb-0">With the craw</p>
                </div>
            </div>
        </header>
        <!-- Section-->
            ...
            <div class="container px-4 px-lg-5 mt-5">
                ...
                <div class="dataTable-top">
                    ...
                    <div class="dataTable-search">
                        &lt;!&ndash;<input class="dataTable-input" placeholder="Search..." type="text">&ndash;&gt;
                    </div>
                </div>
